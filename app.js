...
function signalDashboardCard(id,numericValue){
  // v8.2.4 clean baseline: registra il valore senza applicare effetti visivi.
...
/* v8.3.2 — QUEUED STABLE PER-DIGIT ODOMETER
...
(() => {
  ...
  function animateStableNumber(id,formatted,numericValue){
    ...
    // l'ultimo valore ricevuto e riproducilo appena termina il passaggio corrente.
