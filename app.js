...
function signalDashboardCard(id,numericValue){
  // v8.2.4: qualsiasi cifra realmente aggiornata dentro una card attiva il flash del bordo.
  // Il primo valore ricevuto inizializza il confronto senza produrre effetti.
  ...
  card._liveFrameTimer=setTimeout(()=>card.classList.remove('live-data-up','live-data-down'),1250);
}
